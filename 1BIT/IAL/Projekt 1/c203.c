...
*/
	...
	for (int x = 0; x < QUEUE_SIZE; x++){				//inicializace
		q->arr[x] = '*';
	}
	q->f_index = 0;
	q->b_index = 0;
...
*/
	...
	return (index+1) % QUEUE_SIZE;					//vrati index dalsiho prvku
...
*/
	...
	return (q->f_index == q->b_index);					//pokud je fronta prazdna vrati 1, jinak 0
}
...
*/
	...
	return (nextIndex(q->b_index) == q->f_index);		//pokud je fronta plna vrati 1, jinak 0
}
